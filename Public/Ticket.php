...
if (count($_POST) > 0) {
	...
	if (empty($messages)) {
		$user->replyToTicket($_POST["message"]);
	}
}

$messages = $user->loadTicket();
						...
						<div class="d-flex align-items-center justify-content-between mb-5">
							<div class="d-flex align-items-center">
								...
								<div class="d-flex flex-column">
									<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">Serveur.tech</a>
									<span class="text-muted font-weight-bold font-size-sm">Staff</span>
								</div>
							</div>
			...
			<div class="card card-custom">
				...
				<div class="card-header align-items-center px-4 py-3">
					...
					<div class="text-center flex-grow-1">
						<div class="text-dark-75 font-weight-bold font-size-h5">Serveur.tech</div>
						<!--<div>
...
?>
							...
							<div class="d-flex flex-column mb-5 align-items-start">
								<div class="d-flex align-items-center">
									...
									<div>
										<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">Serveur.tech</a>
