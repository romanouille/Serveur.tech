...
$breadcrumb = "Redémarrer | Serveur #{$_GET["id"]}";
...
?>
	...
	<form method="post">
		...
		<button type="button" class="btn btn-light-primary font-weight-bold btn-sm" onclick="this.disabled=true;document.getElementsByTagName('form')[0].submit()">Cliquez ici pour effectuer un redémarrage du serveur</button>
	</form>
</div>
